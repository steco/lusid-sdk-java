...
public class InstrumentMasterTests {
    ...
    private static void seedInstrumentMaster() throws ApiException
    {
        UpsertInstrumentsResponse upsertInstrumentsResponse = instrumentsApi.upsertInstruments(Map.of(
                ...
                "request1", new InstrumentDefinition()
                ...
                "request2", new InstrumentDefinition()
                        .name("BARCLAYS PLC")
                        .identifiers(Map.of(
                ...
                "request3", new InstrumentDefinition()
                ...
                "request4", new InstrumentDefinition()
                ...
                "request5", new InstrumentDefinition()
    ...
    public void find_non_mastered_instrument_from_external_source() throws ApiException
    {
         ...
         */
        instrumentsApi.upsertInstruments(Map.of("requestId", instrumentDefinition));
